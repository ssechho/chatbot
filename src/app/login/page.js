        ...
        {session ? (
          <div className="grid m-auto text-center">
            <div className="flex flex-col items-center mb-4">
              ...
              />
              <div className="text-2xl mb-12 text-neutral-300">안녕하세요 {session.user.name}님!</div>
            </div>
            <button
              className={`w-40
                        justify-self-center
          ...
          <div className="relative z-10 h-full flex">
            ...
            <div className="w-[30%] flex items-center justify-center">
              <div className="text-center text-white">
                <div className="text-red-500 font-bold text-6xl mb-12">CHATFLIX</div>
                <div className="text-2xl mb-12 text-neutral-300">영화 덕질 친구, CHATFLIX</div>
                <button
